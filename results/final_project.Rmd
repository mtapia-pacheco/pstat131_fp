...
The results suggest that the stronger the penalty, the worse the model performs. 
Our elastic net regression may simply not be needed with our data, so we can try 
other models.
...
svm_lin_grid <- grid_regular(cost(), degree(), levels = 10)
...
```{r}
# visualize ROC curve
augment(rb_final_rf, rainbow_test) %>% 
